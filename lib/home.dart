...
class _HomeState extends State<Home> {
 ...
 void _openGoogleMaps(BuildContext context, String cep, String cidade, String uf) async {
  var endereco = Uri.encodeComponent("$cep, $cidade, $uf");
  var googleMapsUrl = Uri.parse("https://www.google.com/maps/search/?api=1&query=1600+Amphitheatre+Parkway,+Mountain+View,+CA%27");
  ...
  if (await canLaunchUrl(googleMapsUrl)) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text("Erro"),
          content: Text("Não foi possível abrir no Google Maps."),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.of(context).pop();
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfo("Logradouro", resultado['logradouro']),
            _buildInfo("Bairro", resultado['bairro']),
            _buildInfo("Localidade", resultado['localidade']),
            _buildInfo("UF", resultado['uf']),
            SizedBox(height: 10),
            Text(
